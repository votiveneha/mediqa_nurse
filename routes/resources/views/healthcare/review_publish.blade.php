                    ...
                    <div class="card shadow-sm border-0 p-4 mt-30">
                      ...
                      <div class="preview-wrapper">
                            ...
                            <div class="job-preview-card">
                                ...
                                <div class="job-top">
                                    <div class="job-left">
                                        <img alt="{{  Auth::guard('healthcare_facilities')->user()->name }}" src="{{ asset( Auth::guard('healthcare_facilities')->user()->profile_img)}}" class="job-logo">
                       ...
                       <div class="button-row">
                            ...
                            <a class="btn-draft" onclick="saveDraft(1)">Save as Draft</a>

                            <a class="btn-publish" onclick="saveDraft(2)">Publish</a>
