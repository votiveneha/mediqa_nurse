...
<style type="text/css">
  ...
  /*calender css 13/02 */
    ...
    .confirmed { background: #00A81C; }
    .pending { background: #DB6E00; }
    .completed { background: #009BFA; }
    ...
    @media (max-width: 768px) {
      ...
      .fc-button { font-size: 12px !important; padding: 4px 6px !important; }
    }
  ...
  <div class="tab-content mt-4">
        ...
        <!--   <div class="row">
          ...
          <div class="alert-success p-4 rounded">
            ...
            <p class="text-12 lhn mt-2">Vincent uploading your resume makes you 3x more likely to get an interview request</p> 
          ...
          <table class="table table-bordered">
            ...
            <tbody>
              <tr>
                <td>
                  <div>
                <p class="color-black">ICU Nurse</p>
                ...
                <td>
                 <p class="color-black">18 Apr 2026</p>
                  <p class="color-black">2:00 PM - 3:00 PM</p>
                  ...
                  <p class="text-12 p-0">
                    ...
                    <span class="pl-1">employer contact</span>
                  </p>
                  <p class="text-12 p-0">
                    <i class="fa fa-envelope-o" aria-hidden="true"></i>
                    <span class="pl-1">sally.field@canberrahospital.au</span>
                  </p>
                </td>
                <td>
                <p class="color-black">Canberra, ACT</p>
                <p class="color-black">On-site 
                ...
                <td>
                  ...
                  <button class="btn btn-xs mb-1 btn-blue text-white"  
                  data-toggle="modal"
...
<!-- schedule button modal  -->
 ...
 <!--
<div class="modal fade schedmdl-wrapper"
     id="schedModal_1"
     tabindex="-1">
    ...
    <span class="schedstep-label">Completed</span>
      ...
      <div class="modal-body schedmdl-body">
        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            ...
            <div class="schedmdl-note">
              <div class="text-blck"><span><i class="fa fa-sticky-note-o text-blck mr-2" aria-hidden="true"></i></span>
                Add a note...</div>
              <textarea class="form-control mt-2 text-12"
                rows="3"
        ...
        <div class="onsite_bg p-2">
          ...
          <label class="form-check-label text-12 mb-0" for="flexSwitchCheckChecked"><small>On-site  Canberra, ACT</small>
          </label>
        </div>
      </div>
            ...
            <div class="schedmdl-card mt-2">
              <!-- <strong>Contact</strong> -->
               <!--
              <div class="text-12 text-muted d-flex gap-2 align-items-center"><i class="fa fa-user" aria-hidden="true"></i>Sally Field</div>
              
              <div class="text-12 text-muted d-flex gap-2 align-items-center"><i class="fa fa-envelope-o" aria-hidden="true"></i> sally.field@canberra.au</div>
              <div class="text-12 text-muted d-flex gap-2 align-items-center"><i class="fa fa-phone" aria-hidden="true"></i> +61 25555 3333 </div>
            </div>
            <div class="schedmdl-card mt-2">
