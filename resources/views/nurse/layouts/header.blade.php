        ...
        <div class="header-nav">
          <nav class="nav-main-menu">
            <ul class="main-menu">
              ...
              <li class="@if(count($all_tabs) < 15) tooltip-link @endif" @if(count($all_tabs) < 15) data-tooltip="Please complete the profile first" @endif>
                <a class='@if(count($all_tabs) < 15) disabled-link @endif menu-link hover-up {{ request()->is('nurse/match_percentage') ?'active':'' }} {{ request()->is('nurse/application') ?'active':'' }}' href='{{ route("nurse.application") }} '>My Career</i></a>
