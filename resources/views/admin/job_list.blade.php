...
<x-card-component parentHeading="Job Management" childHeading="Job List" parentUrl="{{route('admin.dashboard')}}" />
        ...
        <div class="card-header pb-0 p-4">
            ...
            <div class="d-flex align-items-center justify-content-between">
                ...
                <div>
                    ...
                    <h5 class="card-title fw-semibold mb-0">Job List</h5>

                </div>

                <div>

                    <a href="{{ route('admin.add_jobs') }}" class="btn btn-primary text-nowrap">Add
                    ...
                    <thead class="text-dark fs-4">
                        ...
                        <tr>
                            ...
                            <th>
                                ...
                                <h6 class="fs-4 fw-semibold mb-0">Sector</h6>

                            </th>

                            <th>

                                <h6 class="fs-4 fw-semibold mb-0">Type Of Nurse</h6>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="">
                                            ...
                                            <span class="mb-0 fw-normal fs-3">{{ $item->job_title }}</span>
                                    ...
                                    <td>
                                        ...
                                        <div class="">
                                            ...
                                            <span class="mb-0 fw-normal fs-3">{{ $item->sector }}</span>
                                    ...
                                    <td>
                                        ...
                                        <div class="">
                                            @php
                                            $nurse_type = json_decode($item->nurse_type);
                                            @endphp
                                            <span class="mb-0 fw-normal fs-3">{{ $nurse_type[0] }}</span>
                ...
                <form id="AddCountry"  onsubmit="return addCountry()">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" name="sub_env_id" value="0">
    ...
    <script type="text/javascript">
        ...
        function addCountry() {
            ...
            $.ajax({
                ...
                url: "{{ route('admin.addWorkEnvironment') }}",
                ...
                success: function(res) {
                    ...
                    if (res.status == '2') {
                        ...
                        Swal.fire({
                            ...
                            window.location.href = '{{ route("admin.work_preferences") }}';
        ...
        function editCountry() {
            ...
            $.ajax({
                ...
                url: "{{ route('admin.updateWorkEnvironment') }}",
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        ...
                        url: "{{ route('admin.deleteEnvironment') }}",
        ...
        function getCountry(id) {
            ...
            $.ajax({
                ...
                url: "{{ route('admin.getEnvironment') }}",
