        ...
        <div class="card bg-light-info shadow-none position-relative overflow-hidden">
            <div class="card-body px-4 py-3">
                <div class="row align-items-center">
                    <div class="col-9">
                        <h4 class="fw-semibold mb-8">Healthcare User List</h4>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a class="text-muted " href="{{route('admin.dashboard')}}">Dashboard</a></li>
                                <li class="breadcrumb-item" aria-current="page">Healthcare User List</li>
                            </ol>
                        </nav>
                    </div>
                    <div class="col-3">
                    ...
                    <table class="table border table-striped table-bordered text-nowrap" id="dataTable">
                        <thead class="text-dark fs-4">
                           <tr>
                                ...
                                <th>
                                    <h6 class="fs-4 fw-semibold mb-0">Hospital Name</h6>
                                </th>
                                <th>
                        ...
                        <tbody>
                            @php $i=1 @endphp
                            @if ($healthcare_list)
                                @foreach ($healthcare_list as $key => $item)
                                    <tr>
                                        <td>{{ $i }}</td>
                                        ...
                                        <td>
                                            <div class="">
                                                <span class="mb-0 fw-normal fs-3">
                                                    @php
                                                        $country = DB::table("country")->where("iso2",$item->country_iso)->first();
