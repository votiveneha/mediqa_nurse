                ...
                <div class="col-9">
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item" aria-current="page">{{$job_information->job_title}}   ({{$job_information->job_box_id}})</li>
                        </ol>
                    </nav>
                </div>
                <div class="col-3">
                ...
                <table class="table border table-striped table-bordered text-nowrap" id="dataTable">
                    <thead class="text-dark fs-4">
                        <tr>
                            ...
                            <th>
                                <h6 class="fs-4 fw-semibold mb-0"> Nurse Name</h6>
                            </th>
                            <th>
                                <h6 class="fs-4 fw-semibold mb-0">Mobile No.</h6>
                            </th>
                            <th>
                                <h6 class="fs-4 fw-semibold mb-0">Email</h6>
                            </th>
                            <th>
                                <h6 class="fs-4 fw-semibold mb-0">Applied Date</h6>
                            </th>
                            <th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                 <div class="">
                                    <span class="mb-0 fw-normal fs-3">{{ ucwords($item->nurse->name) }} {{ ucwords($item->nurse->lastname) }}</span>
                                </div>
                            </td>
                            <td>
                                <div class="">
                                    <span class="mb-0 fw-normal fs-3">{{ ucwords($item->nurse->phone) }}</span>
                                </div>
                            </td>
                            <td>
                                <div class="">
                                    <span class="mb-0 fw-normal fs-3"> {{ ucwords($item->nurse->email) }}</span>
                                </div>
                            </td>
                            <td>
                                <div class="">
                                    <span class="mb-0 fw-normal fs-3"> {{ \Carbon\Carbon::parse($item->nurse->updated_at)->format('d-m-Y') }}</span>
                                </div>
                            </td>
                            <td>
