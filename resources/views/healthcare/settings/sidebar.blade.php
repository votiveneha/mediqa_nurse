...
<div class="sidebar_profile">
  ...
  <div class="box-nav-tabs nav-tavs-profile mb-5 p-0 profile-icns">
    <ul class="nav" role="tablist">
      ...
      <li><a class="btn btn-border aboutus-icon mb-20 profile_tabs" href="{{ route('healthcare.chat.index') }}" aria-controls="tab-my-profile" aria-selected="true"><i class="fi fi-rr-bell"></i> Notifications</a></li>
